...
public class ShowMcu2Temp extends AppCompatActivity {
    ...
    private static final String TAG_JSON = "dong2";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        // 비동기 통신을 221.226.209.40/getjson2.php 에 통신을 시도한다.
        getData.execute("http://211.226.209.40/getjson2.php");
        ...
        // 제목을 설정한다.
        setTitle("NodeMcu2_Temperatures");
        // 뒤로가기 버튼을 받아온다
            ...
            public void onRefresh() {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override public void run() {
                        ...
                        // 비동기 통신을 221.226.209.40/getjson2.php 에 통신을 시도한다.
                        getData2.execute("http://211.226.209.40/getjson2.php");
    ...
    public class GetMcuData extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(ShowMcu2Temp.this,
        ...
        protected void onPostExecute(String result) {
            ...
            // 그래프 데이터 주입
                ...
                // 만약 키값이 dong2 로 시작하는지 체크한다.
                if (mJsonString.substring(6, 11).equals("dong2")) {

                    // 밑에 line 1 을위한 데이터들을 담아둔것이 있었다.
                    // 그데이터들을 line 1 에 담아준다. [ Temp1 ] 으로 무슨축인지 표기해준다.
                ...
                if (mJsonString.substring(6, 11).equals("dong2")) {
                    ...
                    // 그데이터들을 line 2 에 담아준다. [ Temp2 ] 으로 무슨축인지 표기해준다.
                ...
                if (mJsonString.substring(6, 11).equals("dong2")) {
                    ...
                    // 그데이터들을 line 3 에 담아준다. [ Temp3 ] 으로 무슨축인지 표기해준다.
                ...
                data = new LineData();
                // 라인데이터에 line1 [Temp1]  의 데이터들을 담아준다.
                data.addDataSet(lineDataSet1);
                // 라인데이터에 line2 [Temp2] 의 데이터들을 담아준다.
                data.addDataSet(lineDataSet2);
                // 라인데이터에 line3 [Temp3] 의 데이터들을 담아준다.
        ...
        private ArrayList<Entry> dataValues3() {
            ...
            try {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    // Json 에서 cnt 으로 정의된 값을 가져와서 안드로이드 cnt 에 넣어준다.
                    String cnt = item.getString(TAG_CNT);
                    // Json 에서 Temp 으로 정의된 값을 가져와서 안드로이드 Temp3 에 넣어준다.
        ...
        private ArrayList<Entry> dataValues4() {
            ...
            try {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    // Json 에서 cnt 으로 정의된 값을 가져와서 안드로이드 cnt 에 넣어준다.
                    String cnt = item.getString(TAG_CNT);
                    // Json 에서 humidity1 으로 정의된 값을 가져와서 안드로이드 Temp1 에 넣어준다.
                    String temp1 = item.getString(TAG_TEMP1);
                    // Json 에서 humidity2 으로 정의된 값을 가져와서 안드로이드 Temp2 에 넣어준다.
                    String temp2 = item.getString(TAG_TEMP2);
                    // Json 에서 humidity3 으로 정의된 값을 가져와서 안드로이드 Temp3 에 넣어준다.
                    String temp3 = item.getString(TAG_TEMP3);
