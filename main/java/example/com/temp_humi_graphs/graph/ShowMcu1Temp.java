...
public class ShowMcu1Temp extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        GetDataMcu1Temp getData = new GetDataMcu1Temp();
        // 비동기 통신을 221.226.209.40/getjson.php 에 통신을 시도한다.
        getData.execute("http://211.226.209.40/getjson.php");
        ...
        // 제목을 설정한다.
        setTitle("NodeMcu1_Temperatures");
        // 뒤로가기 버튼을 받아온다
    ...
    public class GetDataMcu1Temp extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(ShowMcu1Temp.this,
