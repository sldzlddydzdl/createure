...
import example.com.temp_humi_graphs.ChartMenu;
...
public class Mcu2Table extends AppCompatActivity {
...
//        customProgressDialog.setCancelable(false);
    ...
    public class GetDataMcu1Temp extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(Mcu2Table.this,
            ...
            if (result == null) {
                ...
                if (mJsonString.substring(6, 11).equals("dong2")) {
                    ...
                    try {
                        ...
                        // php 에서 "http://211.226.209.40/getjson2.php" 을 json 형태로
